...
export function OwnerCard({ owner }) {
    ...
    return (<Card className="hover:shadow-lg transition-shadow duration-200">
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          ...
          <div className="flex flex-col items-end gap-1">
            ...
            {isOnPace !== undefined && (<Badge variant={isOnPace ? 'default' : 'secondary'} className="text-xs gap-1">
      ...
      <CardContent className="space-y-4">
        {/* Wallet Address */}
        {owner.walletAddress && (<div className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        {/* Metrics */}
        {metrics && (<div className="grid grid-cols-2 gap-3 text-sm">

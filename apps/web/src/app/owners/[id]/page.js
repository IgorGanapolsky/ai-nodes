...
import { ArrowLeft, Mail, Wallet, Calendar, TrendingUp, AlertTriangle, Server, Activity, } from 'lucide-react';
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {isOnPace !== undefined && (<Badge variant={isOnPace ? 'default' : 'secondary'} className="gap-1">
      ...
      {/* Summary Cards */}
      {metrics && !metricsLoading && (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <UtilizationChart ownerId={ownerId} timeframe={timeframe} isLoading={metricsLoading}/>
            </CardContent>
          </Card>
        </TabsContent>

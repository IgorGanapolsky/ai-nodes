...
export async function GET(request, { params }) {
    try {
        ...
        return NextResponse.json({ error: 'Internal server error', message: 'Failed to fetch data from API' }, { status: 500 });
    }
}
export async function POST(request, { params }) {
    try {
        ...
        return NextResponse.json({ error: 'Internal server error', message: 'Failed to send data to API' }, { status: 500 });
    }
}
export async function PUT(request, { params }) {
    try {
        ...
        return NextResponse.json({ error: 'Internal server error', message: 'Failed to update data via API' }, { status: 500 });
    }
}
export async function DELETE(request, { params }) {
    try {
        ...
        return NextResponse.json({ error: 'Internal server error', message: 'Failed to delete data via API' }, { status: 500 });
    }
}

...
export const AlertBanner = ({ alert, onDismiss, onPress, }) => {
    ...
    return (<Animated.View style={[
      ...
      <TouchableOpacity style={styles.content} onPress={() => onPress?.(alert)} activeOpacity={0.7}>
        ...
        <TouchableOpacity style={styles.dismissButton} onPress={handleDismiss} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>

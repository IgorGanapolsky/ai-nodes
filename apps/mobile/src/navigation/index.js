...
const TabNavigator = () => {
    return (<Tab.Navigator screenOptions={{
      ...
      <Tab.Screen name="Earnings" component={EarningsScreen} options={{
            tabBarIcon: ({ color, size }) => (<TabIcon name="earnings" color={color} size={size}/>),
            title: 'Earnings',
        }}/>
      <Tab.Screen name="Nodes" component={NodesScreen} options={{
...
const TabIcon = ({ name, color, size, }) => {
    ...
    return (<Text style={{ fontSize: size, textAlign: 'center' }}>
      {getIcon()}
    </Text>);
};

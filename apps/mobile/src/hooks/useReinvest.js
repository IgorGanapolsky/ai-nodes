...
export const useReinvest = () => {
    ...
    const [lastReinvestAmount, setLastReinvestAmount] = useState(null);
    ...
    const checkAutoReinvest = useCallback(async (currentEarnings) => {
        ...
        if (currentEarnings >= settings.reinvestThreshold) {
            ...
            await notificationService.scheduleLocalNotification('Auto-Reinvest Triggered', `Earnings threshold reached ($${settings.reinvestThreshold}). Starting auto-reinvest...`);

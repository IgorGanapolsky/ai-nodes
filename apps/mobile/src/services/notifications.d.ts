...
export declare class NotificationService {
    ...
    scheduleLocalNotification(title: string, body: string, data?: any, channelId?: string): Promise<string>;
    ...
    addNotificationReceivedListener(listener: (notification: Notifications.Notification) => void): any;
    addNotificationResponseReceivedListener(listener: (response: Notifications.NotificationResponse) => void): any;
}

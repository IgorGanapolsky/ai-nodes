...
import { View, Text, ScrollView, StyleSheet, TouchableOpacity, RefreshControl, ActivityIndicator, Alert, Modal, TextInput, } from 'react-native';
...
const NodesScreen = () => {
    ...
    const { nodes, loading, totalNodes, onlineNodes, offlineNodes, createNode, updateNode, deleteNode, refreshNodes, } = useNodes();
    ...
    const handleDeleteNode = (node) => {
        Alert.alert('Delete Node', `Are you sure you want to delete "${node.name}"? This action cannot be undone.`, [
    ...
    return (<View style={styles.container}>
      ...
      <View style={styles.filterContainer}>
        ...
        ].map(filter => (<TouchableOpacity key={filter.key} style={[
                styles.filterButton,
      ...
      <ScrollView style={styles.scrollView} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={handleRefresh}/>}>
        {filteredNodes.length === 0 ? (<View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtext}>
          ...
          </View>) : (filteredNodes.map(node => (<View key={node.id} style={styles.nodeContainer}>
              <NodeCard node={node} onPress={() => {
              ...
              <View style={styles.nodeActions}>
                ...
                <TouchableOpacity style={[styles.actionButton, styles.deleteButton]} onPress={() => handleDeleteNode(node)}>
        ...
        <View style={styles.modalContainer}>
          ...
          <ScrollView style={styles.modalContent}>
            <View style={styles.formGroup}>
              ...
              <TextInput style={styles.formInput} value={newNode.name} onChangeText={(text) => setNewNode(prev => ({ ...prev, name: text }))} placeholder="Enter node name" autoCapitalize="words"/>
            </View>

            <View style={styles.formGroup}>
              <Text style={styles.formLabel}>Node Type *</Text>
              <View style={styles.typeSelector}>
                {['GPU', 'CPU', 'STORAGE'].map(type => (<TouchableOpacity key={type} style={[
                styles.typeButton,
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput style={styles.formInput} value={newNode.location} onChangeText={(text) => setNewNode(prev => ({ ...prev, location: text }))} placeholder="e.g., US East, Europe West" autoCapitalize="words"/>
            </View>

...
export declare class AlertRepository extends BaseRepository<typeof alerts, Alert, NewAlert> {
    ...
    findBySeverity(severity: string | string[], options?: {
        pagination?: PaginationOptions;
    ...
    createAlert(alertData: Omit<NewAlert, 'id' | 'timestamp' | 'createdAt' | 'updatedAt'>): Promise<Alert>;
    ...
    getRecentAlerts(hours?: number, options?: {
        pagination?: PaginationOptions;
        filters?: AlertFilters;
    }): Promise<QueryResult<Alert>>;
    getAlertTrends(days?: number): Promise<Array<{
        date: string;
        total: number;
        critical: number;
        high: number;

...
import { CacheEntry } from '../interfaces/types';
...
export class CacheManager {
   ...
   */
  private generateKey(connectorType: string, method: string, params?: any): string {
   ...
   */
  async delete(connectorType: string, method: string, params?: any): Promise<boolean> {
    try {
      const key = this.generateKey(connectorType, method, params);
   ...
   */
  async has(connectorType: string, method: string, params?: any): Promise<boolean> {
    const key = this.generateKey(connectorType, method, params);
   ...
   */
  async getTtl(connectorType: string, method: string, params?: any): Promise<number> {
    const key = this.generateKey(connectorType, method, params);

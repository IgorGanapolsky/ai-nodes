 ...
 * @returns CSV string
 */
export declare function recordsToCSV(records: StatementRecord[], options?: CSVExportOptions): string;
/**
 ...
 */
export declare function generateMonthlyStatement(dailyRecords: StatementRecord[], month: number, year: number): StatementSummary;
/**
 ...
 */
export declare function exportStatementSummaryToCSV(summary: StatementSummary, options?: CSVExportOptions): string;
/**
 ...
 */
export declare function parseCSVToRecords(csvContent: string, options?: {
    hasHeader?: boolean;
    delimiter?: string;
}): StatementRecord[];

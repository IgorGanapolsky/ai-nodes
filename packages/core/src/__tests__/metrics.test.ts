...
describe('Metrics Functions', () => {
  ...
  describe('calculateAverageUtilization', () => {
    const createMetrics = (utilizations: number[]): PerformanceMetrics[] => {
  ...
  describe('calculateRevenuePerHour', () => {
    const createRevenueMetrics = (): PerformanceMetrics[] => [
      {
        utilization: 0.5,
        revenueUsd: 120,
        uptime: 0.95,
  ...
  describe('calculatePerformanceScore', () => {
    ...
    it('should handle utilization above 0.8 with diminishing returns', () => {
      const highUtil: PerformanceMetrics = {
        utilization: 0.9,
        revenueUsd: 1000,
        uptime: 1.0,
        timestamp: new Date(),
      ...
      const optimalUtil: PerformanceMetrics = {
        utilization: 0.8,
        revenueUsd: 1000,
        uptime: 1.0,
        timestamp: new Date(),

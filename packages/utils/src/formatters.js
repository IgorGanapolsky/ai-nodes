...
export function formatCurrency(amount, options = {}) {
    const { currency = 'USD', locale = 'en-US', minimumFractionDigits = 2, maximumFractionDigits = 2, notation = 'standard', } = options;
...
export function formatPercentage(value, options = {}) {
    const { locale = 'en-US', minimumFractionDigits = 2, maximumFractionDigits = 2, signDisplay = 'auto', } = options;
    return new Intl.NumberFormat(locale, {
        style: 'percent',
        minimumFractionDigits,
        maximumFractionDigits,
...
export function formatLargeNumber(value, options = {}) {
    const { locale = 'en-US', minimumFractionDigits = 0, maximumFractionDigits = 2, notation = 'compact', } = options;
    return new Intl.NumberFormat(locale, {
        minimumFractionDigits,
        maximumFractionDigits,
        notation,
...
export function formatDate(date, options = {}) {
    const { format: formatString = 'PPP', includeTime = false, relative = false, distance = false, } = options;
    let dateObj;
